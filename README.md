...
2. Unpack the archive (`zip`/`tgz`)
3. If you want to install in a virtual environment, first, create and activate it:
```
python -m venv .venv
source .venv/bin/activate
```
4. Install the package (replace *VERSION* with the correct number)
```
python -m pip install et54-VERSION.tar.gg
```
